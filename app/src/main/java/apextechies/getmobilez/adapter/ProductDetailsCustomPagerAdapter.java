...
public class ProductDetailsCustomPagerAdapter extends PagerAdapter {
    ...
    public void setData(ArrayList<BannerImageModel> res, Context context, ProductDetailsActivity activity) {
        this.models = res;
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        View itemView = mLayoutInflater.inflate(R.layout.productdetails_pageritem, container, false);
    ...
    public void pageSwitcher(int seconds) {
        ...
        timer.scheduleAtFixedRate(new ProductDetailsCustomPagerAdapter.RemindTask(), 0, seconds * 1000); // delay
        // in
        // milliseconds
    }
